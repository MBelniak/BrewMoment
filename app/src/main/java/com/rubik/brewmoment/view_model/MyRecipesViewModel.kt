...
class MyRecipesViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun getAllRecipes(): LiveData<List<Recipe>> {
        ...
        val recipe1 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
        val recipe2 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
        val recipe3 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
        val recipe4 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
        val recipe5 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
        val recipe6 = Recipe("aaa", "aaaa", "aaaa", "desc",
            EqTypeEnum.AEROPRESS, 3, 0, GrindLevelEnum.MEDIUM, true, arrayOf(step1), 90)
